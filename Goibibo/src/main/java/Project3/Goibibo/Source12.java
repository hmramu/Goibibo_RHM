...
// 1. Locating each components using @ Findby annotation
		...
		@FindBy(xpath="//div[@class='sc-sLsrZ iHgrFO']")
		WebElement profile;
		...
		@FindBy(xpath="//h2[@class='sc-19vq0g0-4 glkYOc']")
		WebElement logoutconf;
...
// 2. Creating the method for each component to perform its action
		...
		public void logout_val()
		{
			String actual1= logoutconf.getText();
			String expected1 ="Welcome, Traveller!";
			System.out.println("Passed for logout");
		}
